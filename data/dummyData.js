...
async function Populate() {
  ...
  if (count==0) {
    ...
    const seagulls = await Seagull.insertMany([
    ...
    const popRel = () => {
      ...
      expertises[0].seagulls.push(seagulls[0]);
      expertises[1].seagulls.push(seagulls[1]);
      expertises[2].seagulls.push(seagulls[2]);
      expertises[3].seagulls.push(seagulls[1]);
      expertises[3].seagulls.push(seagulls[3]);
      expertises[0].seagulls.push(seagulls[3]);
      expertises[0].seagulls.push(seagulls[4]);
      expertises[1].seagulls.push(seagulls[4]);
      expertises[2].seagulls.push(seagulls[3]);
      expertises[1].seagulls.push(seagulls[2]);
      expertises[3].seagulls.push(seagulls[0]);
      expertises[2].seagulls.push(seagulls[4]);

      users[0].roles.push(roles[0]);
      users[0].roles.push(roles[1]);
      users[1].roles.push(roles[1]);
      users[2].roles.push(roles[2]);
      users[3].roles.push(roles[2]);
